...
$(function(){
	 ...
	 * '수정' 버튼 처리 Fucntion
	 */
	$('#cmpInfoUpdateBtn').click(function(e){
		
		var result = confirm("회사정보를 수정하시겠습니까?");
		...
		if(result){
			...
			console.log($('#cmpInfoUpdateForm').serialize());
			console.log('formData=============================================');
			e.preventDefault(); // 내장된 이벤트를 차단하는 명령
			$('#cmpInfoUpdateForm').attr('action', '/cmp/info/cmpInfoUpdate');
